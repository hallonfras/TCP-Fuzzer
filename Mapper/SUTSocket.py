...
class SUTSocket:
    """Subclass of sender, adds support for sending commands used by the SUTadapter"""
    ...
    def __init__(self, cmdIp, cmdPort, sender = None):
    ...
    def __str__(self):
        ret =  "SUTSocket with parameters: " + str(self.__dict__)
