...
public class MultiBuilder implements
    ...
    protected AlphabetBuilder<TCPInput> alphabetBuilder = new AlphabetBuilderStandard<>(
        new AlphabetSerializerXml<TCPInput, TCPAlphabetPojoXml>(TCPInput.class, TCPAlphabetPojoXml.class)
    );

    // ExecutionContextImpl, SulBuilderImpl need to be implemented
    protected SulBuilder<TCPInput, TCPOutput, ExecutionContext<TCPInput, TCPOutput, String>> sulBuilder = new TCPSulBuilder();
    protected SulWrapper<TCPInput, TCPOutput, ExecutionContext<TCPInput, TCPOutput, String>> sulWrapper = new SulWrapperStandard<>();
...
// SulClientConfigImpl and MapperConfigImpl need to be implemented
    ...
    @Override
    public StateFuzzer<MealyMachineWrapper<TCPInput, TCPOutput>> build(StateFuzzerEnabler stateFuzzerEnabler) {
