...
public class TCPMapperSul implements AbstractSul<TCPInput, TCPOutput, ExecutionContext<TCPInput, TCPOutput, String>> {
    ...
    protected Mapper<TCPInput, TCPOutput, ExecutionContext<TCPInput, TCPOutput, String>> mapper;

    /** Stores the SulAdapter instance. */
    protected SulAdapter sulAdapter;

    public <T extends SulConfig & TCPMapperConfigProvider> TCPMapperSul(T sulConfig, CleanupTasks cleanupTasks)
        ...
        String mapperAddress = sulConfig.getTCPMapperConfig().getMapperAddress();
        ...
        if (sulConfig.getTCPMapperConfig().getMapperCommand() != null) {
            MapperProcessHandler handler = new MapperProcessHandler(sulConfig.getTCPMapperConfig().getMapperCommand(),
    ...
    @Override
    public Mapper<TCPInput, TCPOutput, ExecutionContext<TCPInput, TCPOutput, String>> getMapper() {
        return mapper;
    }
